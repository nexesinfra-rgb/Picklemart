...
abstract class $StoreDetailsCopyWith<$Res> {
  factory $StoreDetailsCopyWith(
    StoreDetails value,
    $Res Function(StoreDetails) then,
...
abstract class _$$StoreDetailsImplCopyWith<$Res>
  ...
  factory _$$StoreDetailsImplCopyWith(
    _$StoreDetailsImpl value,
    $Res Function(_$StoreDetailsImpl) then,
...
class __$$StoreDetailsImplCopyWithImpl<$Res>
  ...
  __$$StoreDetailsImplCopyWithImpl(
    _$StoreDetailsImpl _value,
    $Res Function(_$StoreDetailsImpl) _then,
  ) : super(_value, _then);
...
class _$StoreDetailsImpl implements _StoreDetails {
  ...
  @override
  String toString() {
    return 'StoreDetails(id: $id, name: $name, address: $address, phone: $phone, email: $email, gstNumber: $gstNumber, logoUrl: $logoUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$StoreDetailsImplToJson(this);
  }
}
